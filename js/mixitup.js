...
function notifyMe() {
    if (!window.Notification) {
        ...
        if (Notification.permission === 'granted') {
            ...
            if(!window.localStorage.getItem("got")){
            window.localStorage.setItem("got","1");
            ...
            Notification.requestPermission().then(function (p) {
                if (p === 'granted') {
                    ...
                    alert("I have a suprise for You, If you allow notification");
                }
            }).catch(function (err) {
                console.error(err);
            });
...
function download_res()
   {
    ...
    link.download = "S ABILASH (resume)";
    link.href ="/assets/resmue/S_ABILASH_RESUME.pdf" ;
    link.click();
   }
   function talk()
   {
       let link = document.createElement("a");
       link.href ="mailto:i8cs008@sairamtap.edu.in";
       link.click();
   }